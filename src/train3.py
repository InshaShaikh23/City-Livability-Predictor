...
csv_path = os.path.join(BASE_DIR, "..", "data", "made3.csv")
...
# Use ALL numeric columns except City & target
...
# SAVE MODEL + FEATURES
# =========================
joblib.dump(model, "../models/livability_model_v3.pkl")
joblib.dump(feature_cols, "../models/feature_columns_v3.pkl")

print("Final livability forecasting model saved!")
